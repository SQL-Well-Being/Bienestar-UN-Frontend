...
function AgendadorAsesoriasFuncionario(){
    ...
    const handleSubmit = async (e) => {
        try {
            ...
            const res = await agendarAsesoriaRequest({DNI: estDni, tipo_cita: tipoCita, fecha: formatedDate});
...
export default AgendadorAsesoriasFuncionario;