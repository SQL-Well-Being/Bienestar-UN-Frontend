...
function DeporteEstudianteDashboard(){
    const [searchParams, setSearchParams] = useSearchParams();
    const [ page, setPage ] = useState("torneos");
    const pages = ["torneos", "selecciones deportivas", "convocatorias selecciones deportivas"];
    const pageLabels = ["Torneos", "Selecciones deportivas", "Convocatorias selecciones deportivas"];
...
export default DeporteEstudianteDashboard;